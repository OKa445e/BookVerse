...
const SeeUserData = ({ userDivData, userDiv, setUserDiv }) => {
  return (
    <>
      <div
        className={`${userDiv === "fixed" ? "fixed" : "hidden"} top-0 left-0 h-screen w-full bg-zinc-800 opacity-80`}
      ></div>
      <div
        className={`${userDiv === "fixed" ? "fixed" : "hidden"} top-0 left-0 h-screen w-full flex items-center justify-center`}
      >
